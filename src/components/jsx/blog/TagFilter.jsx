...
const TagButton = styled.button`
  ...
  &:hover {
    background: ${props => props.active ? COLORS.accentDark : getRgbaColor(COLORS.grayLight)};
    border-color: ${props => props.active ? COLORS.accentDark : getRgbaColor(COLORS.gray)};
  }
