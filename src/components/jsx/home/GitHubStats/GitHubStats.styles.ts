...
interface LanguageBarSegmentProps {
	$percentage: number;
	$color?: string;
}

export const LanguageBarSegment = styled.div<LanguageBarSegmentProps>`
...
export const LanguageBadge = styled.div<LanguageBadgeProps>`
	display: flex;
	align-items: center;
	gap: 8px;
	padding: 8px 14px;
